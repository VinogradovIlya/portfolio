...
int s21_add(s21_decimal value_1, s21_decimal value_2, s21_decimal *result) {
  ...
  if (code == S21_ARITHMETIC_OK) {
    ...
    switch (combo_sing_decimal(bit_3_1.sign, bit_3_2.sign)) {
      ...
      case 2: {
        if (s21_is_greater_or_equal(s21_abs(value_1), value_2)) {
      ...
      case 3: {
        if (s21_is_greater_or_equal(value_1, s21_abs(value_2))) {
          code = sub_algorithm(value_1, value_2, bit_3_1, bit_3_2, result);
          s21_set_sign(result, 0);
        } else {
          code = sub_algorithm(value_2, value_1, bit_3_2, bit_3_1, result);
...
int add_algorithm(s21_decimal value_1, s21_decimal value_2,
  ...
  s21_long_decimal result_long =
      s21_long_decimal_binary_add(value_long_1, value_long_2);
